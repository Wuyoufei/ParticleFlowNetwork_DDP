...
#SBATCH --job-name=my_pn
#SBATCH --qos=debug
#SBATCH --ntasks=2
#SBATCH --mem-per-cpu=4096
#SBATCH --gres=gpu:v100:1
#SBATCH --output=/hpcfs/cepc/higgsgpu/wuzuofei/My_Net/ParticleFlowNetwork/output/my_log/PN_cpu.log
...
python -u script_GPUorCPU/my_train_DDP.py cpu
